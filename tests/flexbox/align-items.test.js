...
const arr = {
  'item-start': { alignItems: 'flex-start' },
  'item-end': { alignItems: 'flex-end' },
  'item-center': { alignItems: 'center' },
  'item-baseline': { alignItems: 'baseline' },
  'item-stretch': { alignItems: 'stretch' },
  // "item-evenly":{alignItems: 'space-evenly'}
};
