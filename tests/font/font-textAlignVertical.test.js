...
const arr = {
  'alignVertical-top': { textAlignVertical: 'top' },
  'alignVertical-center': { textAlignVertical: 'center' },
  'alignVertical-bottom': { textAlignVertical: 'bottom' },
  'alignVertical-auto': { textAlignVertical: 'auto' },
};
